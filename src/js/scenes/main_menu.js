...
export default class MainMenu extends Phaser.Scene {
	...
	create () {
		...
		this.spelInfo = new TextButton(this, screenCenter.x * 0.5, screenCenter.y * 1.5, 200, 100, 'Spel Info', 30, 6, undefined, undefined, () => this.scene.start('gameInfo'));
		this.exitGame = new TextButton(this, screenCenter.x * 1.5, screenCenter.y * 1.5, 230, 100, 'Fullscreen', 30, 6, undefined, undefined, () => { this.scale.toggleFullscreen(); });
	}
}
